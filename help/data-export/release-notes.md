...
![Korrektur](../assets/fix.svg) Der Exporter-Indexer behält jetzt den korrekten Status für abhängige Indexer bei. Zuvor wurden diese Indizes fälschlicherweise invalidiert und erforderten zusätzliche Prüfungen und Überprüfungen, die die Indizierungsleistung verlangsamten. &lt;!-MDEE-866—>

## Version 103.3.13

![Korrektur](../assets/fix.svg) Die Leistung des Datensynchronisierungsprozesses wurde verbessert, indem ein lokaler Cache für Attributoptionen-Daten hinzugefügt wurde.&lt;!-MDEE-864—>

## Version 103.3.12

![Korrektur](../assets/fix.svg) Korrektur eines Problems, das die Synchronisierungszeit für einfache und virtuelle Produkte beschleunigte. &lt;!-MDEE-861—>
